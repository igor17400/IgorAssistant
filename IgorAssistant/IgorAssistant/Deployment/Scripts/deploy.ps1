...
Param(
    [string] $name = "VirtualAssistantIgor",
	[string] $resourceGroup = "VirtualAssistant",
    [string] $location = "westus",
	[string] $appId,
    [string] $appPassword = "igor@bot",
    [string] $luisAuthoringKey = "7bc5b902b9104607b25cae72979ab780",
